...
const CareerPage = () => {
  const googleForm =
    "https://docs.google.com/forms/d/e/1FAIpQLSfq8a4L4gX6e2jRzNC24vwzKSUQwjbxRbHGx4Lqjy3hjn4vPw/viewform?usp=dialog";
              ...
              <div className="relative rounded-2xl bg-white border border-gray-200 overflow-hidden shadow-md w-full flex flex-col">
                ...
                >
                  ...
                  <div className="space-y-3 flex-1">
                    ...
                    <div className="flex items-start gap-3">
                      <Briefcase className="w-5 h-5 text-[#00A86B] mt-0.5" />
                      <div>
