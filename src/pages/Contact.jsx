    ...
    <>
      <style>{`
        ...
        * { font-family: 'Poppins', sans-serif; }
        ...
        @keyframes bounce-icon { 0%,100%{transform:translateY(0) rotate(0deg);} 25%{transform:translateY(-10px) rotate(-5deg);} 75%{transform:translateY(-5px) rotate(5deg);} }
        ...
        .animate-bounce-icon { animation: bounce-icon 3s ease-in-out infinite; }
      `}</style>
